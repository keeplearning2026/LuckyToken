...
- Browser-rendered implementation: `D:\project\Token\artifacts\provider-redesign-profiles-current.png`
- Profile tertiary action state: `D:\project\Token\artifacts\provider-profile-actions-tall-card.png`
- Provider refresh/OAuth icon state: `D:\project\Token\artifacts\provider-refresh-oauth-icons.png`
- Models implementation state: `D:\project\Token\artifacts\provider-redesign-models.png`
- Model editor implementation state: `D:\project\Token\artifacts\provider-redesign-model-editor-icons.png`
- Full-view joined comparison: `D:\project\Token\artifacts\provider-profile-tertiary-comparison.png`
- Focused Profile comparison: `D:\project\Token\artifacts\provider-redesign-profile-focused-comparison.png`
...
- Post-fix evidence: `D:\project\Token\artifacts\provider-redesign-models.png`.
...
- Post-fix evidence: `D:\project\Token\artifacts\provider-redesign-comparison-current.png` and `D:\project\Token\artifacts\provider-redesign-model-editor-icons.png` at the same 1503 × 1047 viewport and device pixel ratio 1.
...
- Post-fix evidence: `D:\project\Token\artifacts\provider-profile-tertiary-comparison.png`, `D:\project\Token\artifacts\provider-profile-actions-tall-card.png`, and `D:\project\Token\artifacts\provider-refresh-oauth-icons.png`.
