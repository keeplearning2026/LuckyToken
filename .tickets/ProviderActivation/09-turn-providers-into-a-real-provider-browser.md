...
- [ ] Source labels are presentation-only mappings of the projected source (`Built in`, `LuckyToken`, `Custom`); package names and internal composition details are not exposed.
