...
**What to build:** Provide the first native Windows management experience. Opening Token starts a thin desktop shell, connects it to the active local Control Plane, and shows an intentionally empty Dashboard with stable navigation to Dashboard, Requests, Analytics, Providers, Models & Aliases, Client Tokens, Diagnostics, and Settings/Developer Lab.
