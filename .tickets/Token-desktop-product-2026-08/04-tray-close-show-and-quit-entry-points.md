...
**What to build:** Keep Token available as a tray application. Closing the main window hides it without terminating the application or gateway; the tray menu can show the window again and exposes the explicit Quit command that later ownership and drain behavior can honor.
