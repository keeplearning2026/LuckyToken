...
- [x] compat fields retain their pinned schema meaning and are not generalized into unrelated Token flags.
...
- [x] Supported OAuth/auth declarations compose without hardcoding Provider-specific flows in Token configuration code.
