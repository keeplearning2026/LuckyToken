# 09 — Run Token as a tray-only Electron product
...
- [x] Opening Token from the tray creates exactly one management window; repeated open actions focus the same live window rather than creating duplicates.
