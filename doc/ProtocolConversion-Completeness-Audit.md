...
| C-15 | installed Pi ToolCall 有 namespace | **已由 0.84.2 基线升级改写** | 历史 0.84.1 安装版无 namespace；当前权威运行时 0.84.2 的 `ToolCall.namespace?: string` 已成为正式 Pi IR 合同。Pi `Tool` 仍无 namespace，因此声明侧可逆 flatten 仍然需要。 |
