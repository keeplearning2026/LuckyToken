...
import { fallback, native } from "./shared.js";

export const commandCodePrivateReasoningAdapter: ReasoningAdapter =
  Object.freeze({
    ...
    projectPayload(
      input: Parameters<ReasoningAdapter["projectPayload"]>[0],
    ) {
      if (
