...
function adapter(api: string): ResponsesReasoningAdapter {
...
export const responsesToOpenAIResponsesReasoningAdapter = adapter("openai-responses");
export const responsesToAzureOpenAIResponsesReasoningAdapter = adapter(
  "azure-openai-responses",
);
export const responsesToOpenAICodexResponsesReasoningAdapter = adapter(
